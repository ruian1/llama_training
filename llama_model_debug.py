...
class LlamaHireezSequence(LlamaForSequenceClassification):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            print("self.num_labels is ", self.num_labels)
            print("self.config.problem_type is", self.config.problem_type)
            ...
            if self.config.problem_type == "regression":
                ...
                loss = CoSENT_loss(labels.view(-1), pooled_logits.view(-1, self.num_labels))
                print("loss is", loss)
